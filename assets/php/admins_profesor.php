...
if ($conexion->connect_error) {
    ...
    $sql_insert = "INSERT INTO MAESTROS (nombre, apellidos, direccion, telefono, contrasena, correo)
     values (\"".$NOMBRE_PROFE."\", \"".$APELLIDOS_PROFE."\", \"".$DIRECCION_PROFE."\", \"".$TELEFONO_PROFE."\", \"".$CONTRASENA."\",  \"".$CORREO_PROFE."\")";
    try {
        echo "\nEntro";
        ...
        echo "\n" . $sql_maestro;
        header('Location: ../../pages/admn-agregar-profesores.html');
