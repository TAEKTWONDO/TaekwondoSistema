                ...
                ?>
                            ...
                            <div class="mdl-card__actions mdl-card--border">
                                <div class="mdl-card__actions" style="text-align: right;">
                                    ...
                                    <a href="category.php?id='+<?php echo $row['id_torneo'] ?>'"> <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--coloredCyan mdl-js-ripple-effect mdl-checkbox__input aling-rights" style="left:-68%;">
