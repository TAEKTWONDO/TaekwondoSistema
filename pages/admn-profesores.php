...
<body >
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <div class="mdl-cell--12-col mdl-grid">
            ...
            <ul>
                <br>
                <h3 class="mdl-list__item-primary-content" style="text-align: center;">Maestros </h3>

               
                <?php foreach ($conexion->query('SELECT nombre, id_maestro FROM MAESTROS') as $row){ // aca puedes hacer la consulta e iterarla con each. ?>
				...
				<?php echo $row['nombre'] ?>
                    ...
                    <a href="../assets/php/admn-delete-prof.php?id='+<?php echo $row['id_maestro'] ?>'" ><button class="mdl-button mdl-js-button mdl-button--raised mdl-button--coloredRed mdl-js-ripple-effect mdl-checkbox__input aling-rights">
